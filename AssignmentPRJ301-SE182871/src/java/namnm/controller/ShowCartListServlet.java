 ...
 * @author Ngoc Lan
 */
@WebServlet(name = "ShowCartListServlet", urlPatterns = {"/ShowCartListServlet"})
...
private final String MARKET_PAGE="market.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            request.setAttribute("CAR_LIST", dto);
         } catch (SQLException | ClassNotFoundException ex) {
            log("ShowCartListServlet _ Exception: " + ex.getMessage(), ex);
        } finally {
